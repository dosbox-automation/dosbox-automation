...
_Ideally, you would also test your changes with a [sanitizer build](https://github.com/dosbox-automation/dosbox-automation/blob/main/docs/build-linux.md#make-a-sanitizer-build) and confirm no issues were found._
...
- [ ] followed the project's [contributing guidelines](https://github.com/dosbox-automation/dosbox-automation/blob/master/docs/CONTRIBUTING.md) and [code of conduct](https://github.com/dosbox-automation/dosbox-automation/blob/master/docs/CODE_OF_CONDUCT.md).
